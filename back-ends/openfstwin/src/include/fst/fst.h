...
class FstHeader {
 public:
  ...
  bool OPENFSTDLL Read(istream &strm, const string &source, bool rewind = false);  //ChangedPD
  bool OPENFSTDLL Write(ostream &strm, const string &source) const;  //ChangedPD
