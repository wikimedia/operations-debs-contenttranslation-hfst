...
#include <fst/unordered_set.h> //ChangedPD
...
int64 OPENFSTDLL StrToInt64(const string &s, const string &src, size_t nline, //ChangedPD
...
void OPENFSTDLL Int64ToStr(int64 n, string *s); //ChangedPD
...
void OPENFSTDLL ConvertToLegalCSymbol(string *s); //ChangedPD
